                        ...
                        <div class="card">
                            <div class="row" style="">
                                <div class="col-lg-4" style="text-align: center; margin-top: 20px; margin-bottom: 20px;padding-top: 20px">
                                    <h3 class="mb-0" id="" >
                                        <strong>Manage Order detail</strong>
                                    </h3>
                                </div>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-hover text-nowrap">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text_page_head" scope="col">User ID</th>
                                                <th class="text_page_head" scope="col">Order Date</th>
                                                <th class="text_page_head" scope="col">Product Name</th> 
                                                <th class="text_page_head" scope="col">Quantity</th> 
                                                <th class="text_page_head" scope="col">Unit Price</th> 
                                            </tr>
                                        </thead>
                                        <tbody id="contentt">
                                        <c:forEach var="a" items="${requestScope.listAllOrderDetail}">
                                            <tr>
                                                <td>${a.order__id}</td>
                                                <td>${a.user__id}</td>
                                                <td>${a.order__date}</td>
                                                <td>${a.product__name}</td>
                                                <td>${a.quantity}</td>
                                                <td>${a.unit__price}</td>
