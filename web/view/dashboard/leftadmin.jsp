...
<nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-green" style="padding: 0px; width: 270px; background-color: black">
    <div class="position-sticky" >
        <div class="list-group list-group-flush mx-3 mt-4" style="margin: 0">
            ...
            <a href="controllerAdmin?site=maindashboard" class="list-group-item list-group-item-action" aria-current="true" style="margin-top: 10px;">
            ...
            <a href="controllerAdmin?site=account" class="list-group-item list-group-item-action" style="margin-top: 10px">
            ...
            <a href="controllerAdmin?site=product" class="list-group-item list-group-item-action" style="margin-top: 10px">
            ...
            <a href="controllerAdmin?site=supplier" class="list-group-item list-group-item-action" style="margin-top: 10px">
