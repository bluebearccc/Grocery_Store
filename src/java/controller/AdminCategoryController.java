...
public class AdminCategoryController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("view/dashboard/mngcategory.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (action) {
            case "delete":
                ...
                break;
            case "search":
                listCate = dao.searchCategory(valueSearch);
                break;
            case "edit":
                request.setAttribute("cateFound", dao.getCategoryById(Integer.parseInt(request.getParameter("id"))));
                request.getRequestDispatcher("view/dashboard/updatecategory.jsp").forward(request, response);
                return;
            case "editSubmmit":
    ...
    private void deleteCate(HttpServletRequest request, HttpServletResponse response) {
        ...
        new CategoryDAO().deleteCategory(Integer.parseInt(idCate));
    }

    private List<Category> searchByName(HttpServletRequest request, HttpServletResponse response) {
        String search = request.getParameter("");
        if (search == null || search.isEmpty()) {
            return new CategoryDAO().getAllCategories();
        }
        return new CategoryDAO().searchCategory(search);
    }
    ...
    private void editCategory(HttpServletRequest request, HttpServletResponse response) {
        ...
        dao.updateCategory(newName, newDes, id);
    }
}
